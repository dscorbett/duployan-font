...
class Builder:
    ...
    def _initialize_schemas(self, noto: bool, light_line: float, stroke_gap: float) -> None:
        ...
        self._schemas = [
            ...
            Schema(0x0025, percent, 1, Type.NON_JOINING, y_max=CAP_HEIGHT, shading_allowed=False),
            ...
            Schema(0x2042, asterism, 1, Type.NON_JOINING, y_min=-148, shading_allowed=False),
            ...
            Schema(0xE002, converging_lines, 1, Type.NON_JOINING, shading_allowed=False),
