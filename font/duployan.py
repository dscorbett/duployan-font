...
LOW_GRAVE = Complex([(333, Space(270))] + HIGH_GRAVE.instructions[1:])
LOW_LONG_GRAVE = Complex([(333, Space(270))] + HIGH_LONG_GRAVE.instructions[1:])
LOW_DOT = Complex([(333, Space(270))] + HIGH_DOT.instructions[1:])
LOW_CIRCLE = Complex([(333, Space(270))] + HIGH_CIRCLE.instructions[1:])
LOW_LINE = Complex([(333, Space(270))] + HIGH_LINE.instructions[1:])
LOW_WAVE = Complex([(333, Space(270))] + HIGH_WAVE.instructions[1:])
LOW_VERTICAL = Complex([(333, Space(270))] + HIGH_VERTICAL.instructions[1:])
